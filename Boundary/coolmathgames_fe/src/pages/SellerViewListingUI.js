      ...
      <>
        ...
        <div className="relative">
          ...
          <div className="flex w-full">
            ...
            <div className="w-1/3 pt-10 justify-end">
              {/*Price*/}
              <div className="flex justify-end">
                <p className="lg:text-3xl md:text-md font-bold">${price}</p>
              </div>
              ...
              <Link to={`/SellerViewREACredentialsUI/${agentUN}`}>
                <div className="flex justify-end pt-6">
                  <button className="flex items-center justify-center bg-transparent text-black p-2 sm:p-3 border border-black rounded-lg hover:bg-white w-full sm:w-auto">
                    <img
                      src={`data:image/jpeg;base64, ${agentImg}`}
                      alt="Agent"
                      className="w-8 h-8 sm:w-10 sm:h-10 rounded-full"
                    />
                    <p className="text-sm sm:text-md px-2 sm:px-3">{agentName}</p>
                  </button>
                </div>
              </Link>
            </div>
