...
function BuyerViewReviewsUI({openModal, onClose, REAName, token}) {
    ...
    useEffect(() => {
        axios.get(`http://127.0.0.1:5000/BuyerRetrieveReviews/${agentName}`, {
            headers: {
...
export default BuyerViewReviewsUI;