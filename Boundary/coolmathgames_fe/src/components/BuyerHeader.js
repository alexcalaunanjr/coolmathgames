...
function BuyerHeader() {
    ...
    return (
        ...
        <Navbar fluid rounded>
            {/* brand logo */}
            <Link to="/BuyerRetrieveNewListingListUI">
            ...
            <div className="flex md:order-2">
                {/* heart */}
                <Link to="/BuyerRetrieveFavoriteListUI" className="mr-4">
            ...
            {/* words on top */}
            <Navbar.Collapse>
                <Link to="/BuyerRetrieveNewListingListUI" className='text-gray-900 hover:text-yellow-700'>New Properties</Link>
                <Link to="/BuyerRetrieveSoldListingListUI" className='text-gray-900 hover:text-yellow-700'>Sold Properties</Link>
                <Link to="/BuyerRetrieveREAListUI" className='text-gray-900 hover:text-yellow-700'>Find Real Estate Agent</Link>
            </Navbar.Collapse>
        </Navbar>
        </>
    );
