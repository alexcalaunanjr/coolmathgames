...
function SellerViewFavoriteCountUI({ propertyName, openModal, onClose, token }) {
...
function displaySellerViewFavoriteCountUI() {
    return (
      <>
  ...
  return (
    displaySellerViewFavoriteCountUI()
  );
} 
export default SellerViewFavoriteCountUI;
