...
function BuyerHeader() {
    ...
    return (
        ...
        <Navbar fluid rounded>
            {/* brand logo */}
            <Navbar.Brand href="#">
                <span className="self-center text-2xl font-Limelight dark:text-white pl-2">MICASA</span>
            </Navbar.Brand>
            ...
            <Navbar.Collapse>
                ...
                <Navbar.Link href="#">My Properties</Navbar.Link>
                <Navbar.Link href="#">Mortgage</Navbar.Link>
                <Navbar.Link href="#">Find Agent</Navbar.Link>
            </Navbar.Collapse>
        </Navbar>
        </>
    );
